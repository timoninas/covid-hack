...
class TestViewController: UIViewController {
    ...
    func showResults() {
        ...
        descriptionLabel.font = UIFont(name:"AppleSDGothicNeo-Medium", size: 23.0)
        ...
        linkText.font = UIFont(name:"AppleSDGothicNeo-Medium", size: 20.0)
