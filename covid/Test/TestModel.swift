...
class TestModel {
    ...
    let warning1 = "Лихорадка - наиболее распространенный симптом коронавирусной инфекции. Срочно звоните на горячую линию (тел. 103) или пройдите консультацию\n\n👇"
    let warning2 = "Кашель - второй по распространенности симптом коронавирусной инфекции. Срочно звоните на горячую линию (тел. 103) или пройдите консультацию\n\n👇"
    let warning3 = "Кашель и боль в грудной клетке при задержке дыхания с высокой долей вероятности указывает на наличие болезни. Пройдите бесплатную консультацию врача\n\n👇"
    let asking = "Это очень важно! Пожалуйста, ограничьте круг общения и звоните на бесплатную горячую линию (тел. 103) или пройдите консультацию\n\n👇"
    
    // Warnings for risc test
    let warning4 = "У люди с астмой с большей вероятностью может развиться тяжёлая форма болезни. При появлении первых симптомов звоните на горячую линию (тел. 103) или пройдите консультацию\n\n👇"
    let warning5 = "У люди с диабетом с большей вероятностью может развиться тяжёлая форма болезни. При появлении первых симптомов звоните на горячую линию (тел. 103) или пройдите консультацию\n\n👇"
    let warning6 = "У пожилых людей с большей вероятностью может развиться тяжёлая форма болезни. Берегите себя! При появлении первых симптомов звоните на горячую линию (тел. 103) или пройдите консультацию\n\n👇"
    
    // Recomendations and instructions
    let recommendation = "Если вас что-то беспокоит, вы можете бесплатно обратиться к врачу\n\n👇"
    let wish = "Будьте осторожны! При появлении первых симптомов срочно звоните на горячую линию (тел. 103) или пройдите консультацию\n\n👇"
    let instruction = "При появлении первых симптомов обращайтесь к доктору онлайн\n\n👇"
   
    // Advertisments
    let advertisment = "Вы можете бесплатно проконсультироваться с врачом по поводу вашего хронического заболевания\n\n👇"
